                    ...
                    <div className="2xl:container 2xl:mx-auto relative  flex justify-start w-96 md:w-10/12 xl:w-8/12 2xl:w-7/12 item-start flex-col lg:flex-row   lg:space-x-8 py-12 md:py-16 lg:py-12 px-4 md:px-8 lg:px-24 bg-white">
                        ...
                        <div className="mt-6 md:mt-8 lg:mt-0 flex justify-start items-start w-full flex-col space-y-6">
                            ...
                            <div className="  mt-10">
                                ...
                                <p3>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum nisi quas quo. Consectetur quasi dolorum tenetur rem, sunt labore voluptatem, 
                                    eligendi ipsa adipisci provident eius, consequatur eos expedita? Consectetur, sequi.</p3>
                            </div>
                            ...
                            <div>
                                <label for="unit type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Unit</label>
                                <input type="text" id="unit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="killos" required />
                            </div>  
                            <div>
                            <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Price per Unit</label>
                                <input type="tel" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123.56" required />
                            </div>
                            <div>
                            <label for="minimum order quantitiy" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Minimum Order Quantity</label>
                                <input type="number" id="moq" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="120"  required />
                            </div>
                            <div>
                                <label for="Shiping fee" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Shiping fee</label>
                            ...
                            <div>
                                ...
                                <label for="Sheeping info" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">I will ship it</label>
                                </div>
                            </div>
                            </form>
                               
                                <button className="border border-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 md:w-96 w-full hover:bg-black text-base font-medium leading-4 bg-red-800 py-4 text-white">Delete Item</button>
                                 </div>
                        </div>
