...
let ProductNavigation = function () {
  return (
        ...
        <div class="px-10 py-10 sm:px-8 lg:px-16 xl:px-20 mx-auto">
          ...
          <div>
            ...
            <select class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
              ...
              <option value="for-rent">type x</option>
              <option value="for-sale">type y</option>
            </select>

            <select class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
              <option value="">product  Type</option>
              <option value="fully-furnished">Used</option>
              <option value="partially-furnished">slightly used</option>
              <option value="not-furnished">New packed</option>
            </select>
