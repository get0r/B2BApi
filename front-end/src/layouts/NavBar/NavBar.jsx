        ...
        <header>
            ...
            <div className="container-menu-desktop ">
                ...
                <div className="wrap-menu-desktop">
                    <nav className="limiter-menu-desktop container bg-light-transparent">
                        ...
                        <div className="wrap-icon-header flex-w flex-r-m">
                            ...
                            <div className="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="2">
                                <i className="zmdi zmdi-shopping-cart"><link to="/cart"></link></i>
                            </div>
            ...
            <div className="wrap-header-mobile">
                ...
                <div className="logo-mobile">
                    <a href="index.html"><img  alt="IMG-LOGO"/></a>
                </div>
